...
const propTypes = {
  ...
  /**
   * A Boolean indicating to start navigation
   * Default value is `false`
   *
   * @platform android & ios
   */
  navigationMode: PropTypes.bool,
...
class MapView extends React.Component {
  ...
  animateToNavigation(region, heading, zoom, viewAngle, duration) {
    this._runCommand('animateToNavigation', [region , heading || 100, zoom || 18, viewAngle || 45, duration || 500]);
  }
